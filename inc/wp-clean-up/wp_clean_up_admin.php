...
function wp_clean_up_admin() {
	add_menu_page( __( 'WP Clean Up Options', 'WP-Clean-Up' ), __( 'WP Clean Up', 'WP-Clean-Up' ), 'manage_options', basename( __FILE__ ), 'wp_clean_up_page' );
}
...
<div class="wrap">
	<?php
	screen_icon();
	echo '<h2>' . __( 'WP Clean Up', 'WP-Clean-Up' ) . '</h2>';
	...
	<table class="widefat" style="width:419px;">
		...
		<tbody id="the-list">
			<tr class="alternate">
				<td class="column-name"><?php _e('Revision','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('revision'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr>
				<td class="column-name"><?php _e('Draft','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('draft'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr class="alternate">
				<td class="column-name"><?php _e('Auto Draft','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('autodraft'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr>
				<td class="column-name"><?php _e('Moderated Comments','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('moderated'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr class="alternate">
				<td class="column-name"><?php _e('Spam Comments','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('spam'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr>
				<td class="column-name"><?php _e('Trash Comments','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('trash'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr class="alternate">
				<td class="column-name"><?php _e('Orphan Postmeta','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('postmeta'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr>
				<td class="column-name"><?php _e('Orphan Commentmeta','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('commentmeta'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr class="alternate">
				<td class="column-name"><?php _e('Orphan Relationships','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('relationships'); ?></td>
				<td class="column-name"><form action="" method="post">
			...
			<tr>
				<td class="column-name"><?php _e('Dashboard Transient Feed','WP-Clean-Up'); ?></td>
				<td class="column-name"><?php echo wp_clean_up_count('feed'); ?></td>
				<td class="column-name"><form action="" method="post">
